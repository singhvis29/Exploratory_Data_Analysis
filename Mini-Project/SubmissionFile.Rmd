...
ggplot(Exp_GDP_Cont_2018, aes(x = X2018_gdp, y = X2018_exp))+ 
  ...
  geom_point(alpha = 0.3)+geom_smooth(color = "green",method = "lm", se = FALSE)+ geom_smooth(method = "loess", se = FALSE)+scale_color_manual(values = cb_palette)+theme(legend.position = "none")+labs(title = "",x = "",y = "")
...
ggplot(Exp_GDP_Cont_2018, aes(x = X2018_gdp, y = X2018_exp,color = continent))+ 
  ...
  theme(legend.position = "none")+labs(title = "",x = "",y = "")
...
ggplot(Exp_GDP_Cont_2018, aes(x = X2018_gdp, y = X2018_exp,color = continent))+ 
  ...
  geom_point(alpha = 0.3)+scale_color_manual(values = cb_palette)+
  geom_smooth(method = "loess", span = 0.5,se = FALSE)+ facet_grid(rows = "continent")+
  theme(legend.position = "none") + labs(title ="" ,x ="" ,y = "")
